...
(function() {
	...
	msgPortMain.init = function() {
		...
		msgPortTizen = new MessagePortTizen("PortApp2");
		
		msgPortTizen.init("PortApp2", msgPortView.addMessage);
	...
	function initMessageRemotePort() {
		...
		msgPortTizen.initRemotePort("PortApp1", "ZSdvscNQTg.MessagePortMApp");
